...
public class RequestLimitService {
    ...
    private final String GLOBAL_REQUEST_LIMIT = "100";
    private final String CLIENT_WINDOW_SIZE = "10000";
    private final String GLOBAL_WINDOW_SIZE = "86400";
    ...
    public RequestLimitResponse canUseService(String uuid, HttpServletRequest request, HttpServletResponse response) {
